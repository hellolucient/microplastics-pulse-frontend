      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        <div className="md:flex md:items-center md:justify-between">
          <div className="flex justify-center md:justify-start mb-4 md:mb-0">
            <Link to="/" className="font-semibold text-brand-darker hover:text-brand-blue transition-colors no-underline">
              MicroPlasticPulse
            </Link>
          </div>

          <nav className="flex flex-wrap justify-center md:justify-start gap-x-6 gap-y-2 mb-4 md:mb-0 md:ml-10">
            <Link to="/" className="text-sm text-brand-dark hover:text-brand-blue transition-colors duration-150 no-underline">Home</Link>
